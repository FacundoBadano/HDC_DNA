...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/facu/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20f4a49a3ec54d235bd28bUxpYAxdQCVFWDQVdAApUBgYFCAQF', mode: 'build'}); } catch(cjsError) { try { import('file:///home/facu/.vscode/extensions/wallabyjs.console-ninja-1.0.377/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20f4a49a3ec54d235bd28bUxpYAxdQCVFWDQVdAApUBgYFCAQF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
